...
# Type of node
export(String, "startnode", "condition", "grouplabel", "jump", "line", "line_random", "loop", "option", "setvar") var type setget set_type,get_type
# path to scene used to create new blocks
export(PackedScene) var block_scene setget set_block_scene,get_block_scene
